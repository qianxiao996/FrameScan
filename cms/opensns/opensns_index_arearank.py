    ...
    def run(self):
        ...
        try:
            ...
            if r"arearank/131000/arealv/2" in req1.text and r"arearank/131000/arealv/2" not in req2.text:
                printGreen("[+]Success:存在opensns index.php 参数arearank注入漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在opensns_index_arearank漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = opensns_index_arearank(sys.argv[1])
    testVuln.run()