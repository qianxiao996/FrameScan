    ...
    def run(self):
        ...
        try:
            ...
            if r"81dc9bdb52d04dc20036dbd8313ed055" in req2.text:
                printGreen("[+]Success:存在FineCMS任意文件上传漏洞...(高危)\t\tpayload: "+shellpath)
            else:
                printBlue("[-]Info:不存在finecms_uploadfile漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = finecms_uploadfile(sys.argv[1])
    testVuln.run()