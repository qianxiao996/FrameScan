    ...
    def run(self):
        ...
        try:
            ...
            if r"qpxjq1qkbjq" in req.text:
                printGreen("[+]Success:存在speedcms list文件参数cid SQL注入漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在speedcms_list_cid_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = speedcms_list_cid_sqli(sys.argv[1])
    testVuln.run()