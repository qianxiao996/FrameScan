...
class etmdcp_Load_filedownload:
    ...
    def run(self):
        ...
        try:
            ...
            if req.headers["Content-Type"] == "application/xml":
                printGreen("[+]Success:存在ETMV9数字化校园平台任意下载漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在etmdcp_Load_filedownload漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = etmdcp_Load_filedownload(sys.argv[1])
    testVuln.run()