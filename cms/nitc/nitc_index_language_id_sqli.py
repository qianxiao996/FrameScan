...
class nitc_index_language_id_sqli:
    ...
    def run(self):
        ...
        try:
            ...
            if r"81dc9bdb52d04dc20036dbd8313ed05" in req.text:
                printGreen("[+]Success:存在NITC营销系统index.php SQL注入漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在nitc_index_language_id_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = nitc_index_language_id_sqli(sys.argv[1])
    testVuln.run()