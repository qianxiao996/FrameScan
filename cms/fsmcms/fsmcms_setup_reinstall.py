    ...
    def run(self):
        ...
        try:
            ...
            if r'</font><input type="text" name="SetUpPath"' in req.text:
                printGreen("[+]Success:存在FSMCMS网站重装漏洞...(中危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在fsmcms_setup_reinstall漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = fsmcms_setup_reinstall(sys.argv[1])
    testVuln.run()
