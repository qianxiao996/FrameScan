    ...
    def run(self):
        ...
        try:
            ...
            if r"Stack trace" not in req1.text and r"Stack trace" in req2.text:
                printGreen("[+]Success:存在JumboECMS V1.6.1 注入漏洞...(高危)\tpayload: "+falseurl)
            else:
                printBlue("[-]Info:不存在jumboecms_slide_id_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = jumboecms_slide_id_sqli(sys.argv[1])
    testVuln.run()