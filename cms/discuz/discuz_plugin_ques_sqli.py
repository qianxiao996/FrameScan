    ...
    def run(self):
        ...
        try:
            ...
            if r"81dc9bdb52d04dc20036dbd8313ed05" in req.text:
                printGreen("[+]Success:存在discuz问卷调查参数orderby注入漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在discuz_plugin_ques_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = discuz_plugin_ques_sqli(sys.argv[1])
    testVuln.run()