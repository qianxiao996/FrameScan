...
class discuz_forum_message_ssrf:
    ...
    def run(self):
        ...
        try:
            ...
            if md5_str in reqr.text:
                printGreen("[+]Success:存在discuz论坛forum.php参数message SSRF漏洞...(中危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在discuz_forum_message_ssrf漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = discuz_forum_message_ssrf(sys.argv[1])
    testVuln.run()
