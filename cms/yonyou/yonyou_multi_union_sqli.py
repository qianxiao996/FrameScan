        ...
        try:
            ...
            for payload in payloads:
                ...
                if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                    printGreen("[+]Success:存在用友致远A6 SQL注入漏洞...(高危)\tpayload: "+vulnurl)
                    noexist = False
            if noexist:
                printBlue("[-]Info:不存在yonyou_multi_union_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = yonyou_multi_union_sqli(sys.argv[1])
    testVuln.run()