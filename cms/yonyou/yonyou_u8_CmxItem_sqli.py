    ...
    def run(self):
        ...
        try:
            ...
            if time.time() - start_time >= 6:
                printGreen("[+]Success:存在用友u8 CmxItem.php SQL注入漏洞...(高危)\tpayload: "+vulnurl+"\npost: "+json.dumps(post_data, indent=4))
            else:
                printBlue("[-]Info:不存在yonyou_u8_CmxItem_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = yonyou_u8_CmxItem_sqli(sys.argv[1])
    testVuln.run()