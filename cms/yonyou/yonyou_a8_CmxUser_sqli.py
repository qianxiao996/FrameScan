    ...
    def run(self):
        ...
        try:
            ...
            if time.time() - start_time >= 6:
                printGreen("[+]Success:存在用友优普a8 CmxUserSQL时间盲注入漏洞...(高危)\tpayload: "+vulnurl+"\npost: "+json.dumps(post_data, indent=4))
            else:
                printBlue("[-]Info:不存在yonyou_a8_CmxUser_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = yonyou_a8_CmxUser_sqli(sys.argv[1])
    testVuln.run()