...
class acsoft_GetXMLList_fileread:
    ...
    def run(self):
        ...
        try:
            ...
            if req.headers["Content-Type"] == "application/xml":
                printGreen("[+]Success:存在安财软件GetXMLList任意文件读取漏洞...(高危)\tpayload: "+vulnurl+"\npost: "+json.dumps(post_data, indent=4))
            else:
                printBlue("[-]Info:不存在acsoft_GetXMLList_fileread漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = acsoft_GetXMLList_fileread(sys.argv[1])
    testVuln.run()