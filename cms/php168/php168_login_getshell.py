    ...
    def run(self):
        ...
        try:
            ...
            if r"81dc9bdb52d04dc20036dbd8313ed055" in req2.text:
                printGreen("[+]Success:存在PHP168 GETSHELL漏洞...(高危)\tpayload: "+verifyurl)
            else:
                printBlue("[-]Info:不存在php168_login_getshell漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = php168_login_getshell(sys.argv[1])
    testVuln.run()