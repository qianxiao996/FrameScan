...
class phpok_remote_image_getshell:
    ...
    def run(self):
        ...
        try:
            ...
            if md5_str in reqr.text:
                printGreen("[+]Success:存在phpok remote_image getshell漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在phpok_remote_image_getshell漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = phpok_remote_image_getshell(sys.argv[1])
    testVuln.run()
