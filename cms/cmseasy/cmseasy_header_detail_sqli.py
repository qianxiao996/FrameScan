...
class cmseasy_header_detail_sqli:
    ...
    def run(self):
        ...
        try:
            ...
            if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                printGreen("[+]Success:存在cmseasy header.php 报错注入漏洞...(高危)\tpayload: "+vulnurl+"\npost: "+json.dumps(post_data, indent=4))
            else:
                printBlue("[-]Info:不存在cmseasy_header_detail_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = cmseasy_header_detail_sqli(sys.argv[1])
    testVuln.run()