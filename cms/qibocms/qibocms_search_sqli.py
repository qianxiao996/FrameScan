    ...
    def run(self):
        ...
        try:
            ...
            if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                printGreen("[+]Success:存在qibocms知道系统注入漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在qibocms_search_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = qibocms_search_sqli(sys.argv[1])
    testVuln.run()