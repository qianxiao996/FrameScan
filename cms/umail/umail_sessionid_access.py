    ...
    def run(self):
        ...
        try:
            ...
            if r'<meta http-equiv="refresh" content="0; URL=index.php">' in req.text:
                printGreen("[+]Success:存在umail sessionid登录漏洞...(中危)\tpayload: "+vulnurl+"\npost: "+json.dumps(post_data, indent=4))
            else:
                printBlue("[-]Info:不存在umail_sessionid_access漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = umail_sessionid_access(sys.argv[1])
    testVuln.run()