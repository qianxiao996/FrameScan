        ...
        try:
            for payload in payloads:
                ...
                if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                    printGreen("[+]Success:存在Gobetters视频会议系统SQL注入漏洞...(高危)\tpayload: "+vulnurl)
            ...
            if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                ...
                printBlue("[-]Info:不存在gobetters_multi_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = gobetters_multi_sqli(sys.argv[1])
    testVuln.run()