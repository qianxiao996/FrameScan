...
class shopnc_index_class_id_sqli:
    ...
    def run(self):
        ...
        try:
            ...
            if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                printGreen("[+]Success:存在shopNC B2B版 index.php SQL注入漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在shopnc_index_class_id_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = shopnc_index_class_id_sqli(sys.argv[1])
    testVuln.run()