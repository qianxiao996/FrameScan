    ...
    def run(self):
        ...
        try:
            ...
            if r"common.inc.php" in req.text:
                printGreen("[+]Success:存在帝友P2P借贷系统任意文件读取漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在dyp2p_url_fileread漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = dyp2p_url_fileread(sys.argv[1])
    testVuln.run()