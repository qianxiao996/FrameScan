...
class wordpress_woocommerce_code_exec:
    ...
    def run(self):
        ...
        try:
            ...
            if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                printGreen("[+]Success:存在wordpress 插件WooCommerce PHP代码注入漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在wordpress_woocommerce_code_exec漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = wordpress_woocommerce_code_exec(sys.argv[1])
    testVuln.run()