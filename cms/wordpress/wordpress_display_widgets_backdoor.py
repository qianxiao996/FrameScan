...
class wordpress_display_widgets_backdoor:
    ...
    def run(self):
        ...
        try:
            ...
            if req.status_code == 200:
                printGreen("[+]Success:存在wordpress display-widgets插件后门漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在wordpress_display_widgets_backdoor漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = wordpress_display_widgets_backdoor(sys.argv[1])
    testVuln.run()
