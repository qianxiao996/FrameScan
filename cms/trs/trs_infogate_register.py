    ...
    def run(self):
        ...
        try:
            ...
            if r"CUSTOMERUSER" in req.text and r"CUSTOMERUSERID" in req.text:
                printGreen("[+]Success:存在trs infogate插件 任意注册漏洞...(高危)\tpayload: "+vulnurl+"\npost: "+json.dumps(post_data, indent=4))
            else:
                printBlue("[-]Info:不存在trs_infogate_register漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = trs_infogate_register(sys.argv[1])
    testVuln.run()