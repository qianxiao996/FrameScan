    ...
    def run(self):
        ...
        try:
            ...
            if r"<web-app" in req.text:
                printGreen("[+]Success:存在拓尔思wcm pre.as 文件包含漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在trs_wcm_pre_as_lfi漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = trs_wcm_pre_as_lfi(sys.argv[1])
    testVuln.run()
