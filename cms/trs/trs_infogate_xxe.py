    ...
    def run(self):
        ...
        try:
            ...
            if md5_str in reqr.text:
                printGreen("[+]Success:存在trs infogate插件 XML实体注入漏洞...(高危)\tpayload: "+vulnurl+"\npost: "+json.dumps(post_data, indent=4))
            else:
                printBlue("[-]Info:不存在trs_infogate_xxe漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = trs_infogate_xxe(sys.argv[1])
    testVuln.run()
