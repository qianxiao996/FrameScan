...
class trs_was5_config_disclosure:
    ...
    def run(self):
        ...
        try:
            ...
            if r"sysdriver" in req.text and r"sysuser" in req.text:
                printGreen("[+]Success:存在TRS was5配置文件泄露漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在trs_was5_config_disclosure漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = trs_was5_config_disclosure(sys.argv[1])
    testVuln.run()