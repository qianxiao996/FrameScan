    ...
    def run(self):
        ...
        try:
            ...
            if r"WCM IMPORTS BEGIN" in req.text and r"main.jsp" in req.text:
                printGreen("[+]Success:存在TRS wcm系统默认账户漏洞...(高危)\tpayload: "+vulnurl+"\npost: "+json.dumps(post_data, indent=4))
            else:
                printBlue("[-]Info:不存在trs_wcm_default_user漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = trs_wcm_default_user(sys.argv[1])
    testVuln.run()