    ...
    def run(self):
        ...
        try:
            ...
            if r"updatexml" in req.text and r"XPATH" in req.text:
                printGreen("[+]Success:存在ecshop uc.php参数code SQL注入漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在ecshop_uc_code_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = ecshop_uc_code_sqli(sys.argv[1])
    testVuln.run()