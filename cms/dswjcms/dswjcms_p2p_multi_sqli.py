        ...
        try:
            for payload in payloads:
                ...
                if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                    printGreen("[+]Success:存在Dswjcms p2p网贷系统注入漏洞...(高危)\tpayload: "+vulnurl)
                    sys.exit(1)

            printBlue("[-]Info:不存在dswjcms_p2p_multi_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = dswjcms_p2p_multi_sqli(sys.argv[1])
    testVuln.run()