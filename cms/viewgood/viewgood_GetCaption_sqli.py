...
class viewgood_GetCaption_sqli:
    ...
    def run(self):
        ...
        try:
            ...
            if r"tyqMicrosoft" in req.text:
                printGreen("[+]Success:存在远古流媒体系统 GetCaption.ashx注入漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在viewgood_GetCaption_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = viewgood_GetCaption_sqli(sys.argv[1])
    testVuln.run()