    ...
    def run(self):
        ...
        try:
            ...
            if r"BBBMicrosoft" in req.text:
                printGreen("[+]Success:存在远古流媒体系统两处SQL注入漏洞...(高危)\tpayload: "+vulnurl+"\tpost: "+json.dumps(post_data))
            ...
            if r"BBBMicrosoft" in req.text:
                ...
                printBlue("[-]Info:不存在viewgood_two_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = viewgood_two_sqli(sys.argv[1])
    testVuln.run()