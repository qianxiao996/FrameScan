...
class phpcms_flash_upload_sqli:
    ...
    def run(self):
        ...
        try:
            ...
            if r"63e1f04640e83605c1d177544a5a0488" in req.text:
                printGreen("[+]Success:存在phpcms2008 flash_upload.php SQL注入漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在phpcms_flash_upload_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = phpcms_flash_upload_sqli(sys.argv[1])
    testVuln.run()