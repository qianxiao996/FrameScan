    ...
    def run(self):
        ...
        try:
            ...
            if r"XPATH syntax error" in req3.text:
                printGreen("[+]Success:存在phpcms v9.6.0 SQL注入漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在phpcms_v96_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = phpcms_v96_sqli(sys.argv[1])
    testVuln.run()
