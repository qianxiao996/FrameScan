    ...
    def run(self):
        ...
        try:
            ...
            if md5_value in flash_md5:
                printGreen("[+]Success:存在phpcms v9 flash xss漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在phpcms_v9_flash_xss漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = phpcms_v9_flash_xss(sys.argv[1])
    testVuln.run()