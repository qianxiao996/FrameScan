    ...
    def run(self):
        ...
        try:
            ...
            if r"<?php" in req4.text and r"phpsso" in req4.text:
                printGreen("[+]Success:存在phpcms 9.6.1任意文件读取漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在phpcms_v961_fileread漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = phpcms_v961_fileread(sys.argv[1])
    testVuln.run()
