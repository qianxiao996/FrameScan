    ...
    def run(self):
        ...
        try:
            ...
            if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                printGreen("[+]Success:存在PHPCMS digg_add.php SQL注入漏洞...(高危)\t\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在phpcms_digg_add_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = phpcms_digg_add_sqli(sys.argv[1])
    testVuln.run()
