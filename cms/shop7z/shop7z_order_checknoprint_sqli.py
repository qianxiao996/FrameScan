...
class shop7z_order_checknoprint_sqli:
    ...
    def run(self):
        ...
        try:
            ...
            if r"#tyq#" in req.text:
                printGreen("[+]Success:存在shop7z order_checknoprint.asp SQL注入漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在shop7z_order_checknoprint_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = shop7z_order_checknoprint_sqli(sys.argv[1])
    testVuln.run()