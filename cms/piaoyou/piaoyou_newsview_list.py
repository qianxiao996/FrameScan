    ...
    def run(self):
        ...
        try:
            ...
            if r"BBBMicrosoft" in req.text:
                printGreen("[+]Success:存在票友票务系统通用sql注入漏洞...(高危)\tpayload: "+vulnurl)
            ...
            if r"BBBMicrosoft" in req.text:
                ...
                printBlue("[-]Info:不存在piaoyou_newsview_list漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = piaoyou_newsview_list(sys.argv[1])
    testVuln.run()