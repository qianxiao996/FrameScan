    ...
    def run(self):
        ...
        try:
            ...
            if r"BBBMicrosoft" in req.text:
                printGreen("[+]Success:存在票友票务系统int_order.aspx SQL注入漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在piaoyou_int_order_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = piaoyou_int_order_sqli(sys.argv[1])
    testVuln.run()