        ...
        try:
            ...
            for url in urls:
                ...
                if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                    printGreen("[+]Success:存在票友机票预订系统10处SQL注入漏洞...(高危)\tpayload: "+vulnurl)
                    noexist = False
            if noexist:
                printBlue("[-]Info:不存在piaoyou_ten_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = piaoyou_ten_sqli(sys.argv[1])
    testVuln.run()
