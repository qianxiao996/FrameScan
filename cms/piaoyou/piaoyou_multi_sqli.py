        ...
        try:
            ...
            for url in urls:
                ...
                if r"WtFaBcMic" in req.text:
                    printGreen("[+]Success:存在票友机票预订系统SQL注入漏洞...(高危)\tpayload: "+vulnurl)
                    noexist = False
            if noexist:
                printBlue("[-]Info:不存在piaoyou_multi_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = piaoyou_multi_sqli(sys.argv[1])
    testVuln.run()