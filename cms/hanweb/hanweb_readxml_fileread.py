    ...
    def run(self):
        ...
        try:
            ...
            if r"<driver-properties>" in req.text:
                printGreen("[+]Success:存在大汉版通JCMS数据库读取漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在hanweb_readxml_fileread漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = hanweb_readxml_fileread(sys.argv[1])
    testVuln.run()