    ...
    def run(self):
        ...
        try:
            ...
            if req.status_code == 200:
                ...
                if m:
                    printGreen("[+]Success:存在泛微OA downfile.php 任意文件下载漏洞...(高危)\tpayload: "+self.url)
                else:
                    printBlue("[-]Info:不存在weaver_oa_filedownload漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = weaver_oa_filedownload(sys.argv[1])
    testVuln.run()