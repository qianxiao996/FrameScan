    ...
    def run(self):
        ...
        try:
            ...
            if r"comment.php" in req.text:
                printGreen("[+]Success:存在seacms 6.45 search.php order参数前台代码执行漏洞...(高危)\tpayload: "+vulnurl+"\npost: "+json.dumps(post_data, indent=4))
            else:
                printBlue("[-]Info:不存在seacms_order_code_exec漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = seacms_order_code_exec(sys.argv[1])
    testVuln.run()
