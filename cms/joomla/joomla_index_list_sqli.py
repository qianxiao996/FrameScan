    ...
    def run(self):
        ...
        try:
            ...
            if r"81dc9bdb52d04dc20036dbd8313ed05" in req.text:
                printGreen("[+]Success:存在joomla 3.7.0 core SQL注入漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在joomla_index_list_sqli漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = joomla_index_list_sqli(sys.argv[1])
    testVuln.run()