    ...
    def run(self):
        ...
        try:
            ...
            if req.status_code == 200 and r"<?php" in req.text:
                printGreen("[+]Success:存在joomla组件com_docman本地文件包含漏洞...(高危)\tpayload: "+vulnurl)
            else:
                printBlue("[-]Info:不存在joomla_com_docman_lfi漏洞")
...
if __name__ == "__main__":
    ...
    testVuln = joomla_com_docman_lfi(sys.argv[1])
    testVuln.run()